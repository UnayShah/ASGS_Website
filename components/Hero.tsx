...
const Hero = () => {
        ...
        useEffect(() => {
                const handleMargin = () => {
                        ...
                        setImageBorderRadius((window.scrollY / 10) + 'px');
                }
        ...
        return (
                <div className="flex items-center justify-center h-screen mb-12 bg-fixed bg-center main-image"
                        style={{ marginLeft: `${imageMargin}`, marginRight: `${imageMargin}`, borderBottomLeftRadius: `${imageBorderRadius}`, borderBottomRightRadius: `${imageBorderRadius}`, }}>
